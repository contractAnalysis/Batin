...
# import batin.laser.ethereum.util as helper
import batin.laser_util as helper

# from batin.ethereum.evmcontract import EVMContract
from batin.EVMContract import EVMContract
# from batin.ethereum.util import get_solc_json

from batin.util import get_solc_json
from batin.exceptions import NoContractFoundError
...
class SolidityFile:
    ...
    def __init__(self, filename: str, data: str, full_contract_src_maps: Set[str]):
        """
        Metadata class containing data regarding a specific mapper file
        :param filename: The filename of the mapper file
        :param data: The code of the mapper file
